...
function form_atos() {
	global $wpdb;
	$output='';
	$automatic_response_file_path=__WPRoot__.'/automatic_response.php';
	if(!file_exists($automatic_response_file_path)){
		$output.='<tr><td colspan=2><span class="small description" style="color:red">You should copy the file automatic_response.php to <pre>'.$automatic_response_file_path.'</pre></td></tr>';
	}
	else {
		$output.='<tr><td colspan=2><span class="small description" style="color:green">automatic_response.php copied to <pre>'.$automatic_response_file_path.'</pre>, ok !</td></tr>';
	}
